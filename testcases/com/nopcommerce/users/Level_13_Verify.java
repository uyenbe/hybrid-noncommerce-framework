...
public class Level_13_Verify extends BaseTest {
    ...
    public void User_01_RegisterPage() {
        ...
        // Assert 01
        verifyEquals(userRegisterPage.getRegisterTitle(), "REGISTER");
        ...
        //Asert 02
        verifyEquals(userRegisterPage.getRegisterMessage(),"Your registration completed!!");
    ...
    public void User_03_CustomerInforPage() {
        ...
        verifyTrue(userCustomerInforPage.isGenderMaleSelected());
        ...
        verifyEquals(userCustomerInforPage.getEmailTextboxValue(),emailAddress);
