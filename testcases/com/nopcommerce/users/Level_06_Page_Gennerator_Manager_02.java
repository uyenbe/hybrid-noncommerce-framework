...
public class Level_06_Page_Gennerator_Manager_02 extends BaseTest {
    ...
    public void User_01_RegisterPage() {
       ...
       // homePage.clickToRegisterLink(); //page A: HomePage
        //Cách 2:
        // Chuyển việc khởi tạo các page từ ngoài testClass vào từng pageObject
        // Không vi phạm tính đóng gói trong OOP - che giấu đi việc khởi tạo 1 đối tượng
        //Nhưng vẫn Lặp lại việc khởi tạo page ở các step sau - Vi phạm nguyên tắc DRY - Ko lặp lại tính năng/dòng code trong 1 class haowjc framework
        // Có sự kết nối giữa 2 page với nhau - khi TCs có sự kết nối giữa 2 page với nhau thì code sẽ ngắn gọn, dễ đọc, dễ hiểu hơn

        // Từ HomePage chuyển sang RegisterPage: từ page A sang page B
        // registerPage = new RegisterPageObject(driver);
        // >> được chuyển sang khởi tạo tài hàm clickToRegisterLink
