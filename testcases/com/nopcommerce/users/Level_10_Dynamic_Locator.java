...
public class Level_10_Dynamic_Locator extends BaseTest {
    ...
    public void User_04_Dynamic_Page() {
        ...
        userAdressPage = (UserAdressPO) userCustomerInforPage.openSidebarLinkByPageName("Address");
        userAdressPage.sleepInSeconds(2);

        // Chuyển từ Address page >> Order page
        userOrderPage = (UserOrderPO) userAdressPage.openSidebarLinkByPageName("Order");
