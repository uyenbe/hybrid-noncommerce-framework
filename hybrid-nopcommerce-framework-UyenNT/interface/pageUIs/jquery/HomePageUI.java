...
public class HomePageUI {
    ...
    public static final String DYNAMIC_DATA_IN_ROW = "xpath=//td[@data-key='females' and text()='%s']/following-sibling::" +
    ...
    public static final String DYNAMIC_DELETE_BUTTON = "xpath=//td[@data-key='country' and text()='%s']/preceding-sibling::td[@class='qgrd-actions']//button[contains(@class, 'remove')]";
    public static final String DYNAMIC_SEARCH_RESULT = "xpath=//td[@data-key='country' and text()='%s']";
}
